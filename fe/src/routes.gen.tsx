import { Outlet, ReactRouter, RootRoute, Route, RouterProvider, lazy } from "@tanstack/react-router";
...
const console = new Route({
  getParentRoute: () => root,
  path: "console",
  component: lazy(() => import("./pages/console")),
});
const index = new Route({ getParentRoute: () => root, path: "/", component: lazy(() => import("./pages/index")) });

const config = root.addChildren([console, index, _404]);
